  ...
  return (
    <article className="flex flex-col md:flex-row items-center gap-8 bg-purple-900/10 border border-white/10 rounded-lg p-6">
      ...
      <div className="flex flex-col gap-2">
        <h3 className="text-[1.5rem] md:text-[1.75rem] font-semibold text-center md:text-left">{title}</h3>
        <p className="text-sm md:text-base text-center md:text-left">{description}</p>
      </div>
    </article>
  );
}