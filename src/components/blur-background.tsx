export default function BlurBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden -z-10">
      ...
      <div
        className="hidden md:block absolute w-64 h-64 bg-fuchsia-500/20 rounded-full blur-3xl"
        style={{
          top: '25%',
          right: '2%',
        }}
      ...
      <div
        className="hidden md:block absolute w-72 h-72 bg-sky-400/20 rounded-full blur-3xl"
        style={{
          top: '60%',
          left: '1%',
        }}
